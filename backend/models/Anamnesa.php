 ...
 * @property integer $kebiasan_olahraga_pil
...
class Anamnesa extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'kebiasan_olahraga_pil' => Yii::t('app', 'Kebiasan Olahraga Pil'),
