...
class SaranAnjuran extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'radiologi_ctscan_pil' => 'Radiologi Ctscan Pil',
            'radiologi_ct_scan' => 'Radiologi Ct Scan',
            'radiologi_usg_pil' => 'Radiologi Usg Pil',
            'radiologi_usg' => 'Radiologi Usg',
            'radiologi_mri_pil' => 'Radiologi Mri Pil',
            'radiologi_mri' => 'Radiologi Mri',
            'radiologi_xray_pil' => 'Radiologi Xray Pil',
            'radiologi_xray' => 'Radiologi Xray',
            'radiologi_lain_pil' => 'Radiologi Lain Pil',
