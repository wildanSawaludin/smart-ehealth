...
<div class="row">
    ...
    <div class="form-group">
        ...
        <input type="text" id="no_resep" readonly="true"><a id="isi_no_resep_racikan" class="btn btn-info">Isi No Resep</a>
        <br>
    ...
    <input type="hidden" name="id_resep_nonracikan" value="<?= $resepRacikan['id']; ?>">
    <div class="form-group">
